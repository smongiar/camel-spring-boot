...
@ConditionalOnHierarchicalProperties({"camel.component", "camel.component.sap-trfc-destination"})
...
public class SapTransactionalRfcDestinationComponentAutoConfiguration {
    ...
    @Lazy
    @Bean
    public ComponentCustomizer configureSapTransactionalRfcDestinationComponent() {
        return new ComponentCustomizer() {
            ...
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof SapTransactionalRfcDestinationComponent;
            }
        };
    }
}