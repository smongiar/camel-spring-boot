...
@ConditionalOnHierarchicalProperties({"camel.component", "camel.component.sap-srfc-destination"})
...
public class SapSynchronousRfcDestinationComponentAutoConfiguration {
    ...
    @Lazy
    @Bean
    public ComponentCustomizer configureSapSynchronousRfcDestinationComponent() {
