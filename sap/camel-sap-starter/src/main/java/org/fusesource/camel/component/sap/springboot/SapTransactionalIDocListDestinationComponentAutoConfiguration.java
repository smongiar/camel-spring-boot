...
@ConditionalOnHierarchicalProperties({"camel.component", "camel.component.sap-idoclist-destination"})
...
public class SapTransactionalIDocListDestinationComponentAutoConfiguration {
    ...
    @Autowired
    private SapTransactionalIDocListDestinationComponentConfiguration configuration;
    ...
    @Lazy
    @Bean
    public ComponentCustomizer configureSapTransactionalIDocListDestinationComponent() {
        return new ComponentCustomizer() {
            ...
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof SapTransactionalIDocListDestinationComponent;
            }
        };
    }
}